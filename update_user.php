...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" required placeholder="Masukkan nama pengguna" maxlength="20"  class="box" value="<?= $fetch_profile["name"]; ?>">
      ...
      <input type="submit" value="Perbarui Profil" class="btn" name="submit">
   </form>
